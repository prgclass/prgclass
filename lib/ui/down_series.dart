...
//============================(CLASS-MOVIE-1)===================================
class MostSeries extends StatefulWidget {
  int page = 0;
  List<SeriesData> allSeries = [];

  MostSeries({super.key});
  @override
  State<MostSeries> createState() => _SeriesState();
}

class _SeriesState extends State<MostSeries> {
  ...
  Future<void> loadSeries() async {
    ...
    List<SeriesData> newSeries = await mediaRepository.getloved(widget.page);
    setState(() {
      widget.allSeries.addAll(newSeries);
      isLoading = false;
    });
  }
